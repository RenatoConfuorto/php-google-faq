...
<body>
  ...
  $faq = [
    ...
    <p></p>Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.</p>
    <div>
  ...
  <header>
    <div class="header-top">
      <div class="logo">
        <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="Google_logo">
        <span>Privacy e Sicurezza</span>
      </div>
      <div class="icons">
        <svg class="gb_Te" focusable="false" viewBox="0 0 24 24">
